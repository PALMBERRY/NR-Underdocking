...
dmtxMatrix3Rotate(DmtxMatrix3 m, double angle)
{
   ...
   sinAngle = sindp_i(angle);
   cosAngle = cosdp_i(angle);
...
extern void dmtxMatrix3LineSkewTop(DmtxMatrix3 m, double b0)
{
...
extern void dmtxMatrix3LineSkewTopInv(DmtxMatrix3 m, double b0)
{
...
extern void dmtxMatrix3LineSkewSide(DmtxMatrix3 m, double b1)
{
   //assert(b0 >= DmtxAlmostZero);
...
extern void dmtxMatrix3LineSkewSideInv(DmtxMatrix3 m, double b1)
{
   assert(b1 >= DmtxAlmostZero);
